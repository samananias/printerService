...
**Status:** 🚧 In development — reliability & PIN auth (P8) done; printing (P5) pending the printer spike. Roadmap: [docs/SOURCE_OF_TRUTH.md](docs/SOURCE_OF_TRUTH.md) Section 9.
