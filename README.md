...
**Status:** 🚧 In development — printing pipeline built (P5) around SumatraPDF; end-to-end paper test pending SumatraPDF install. Roadmap: [docs/SOURCE_OF_TRUTH.md](docs/SOURCE_OF_TRUTH.md) Section 9.
